...
"DECODE BY IMRAN"
"FIX BY NOOR"
"DECODE TIME : 13 MARCH 2025"
"FIX TIME : 13 MARCH 2025"
"------------------------------------------------------------"
#------------------[ MODULE ]-----------------#
...
#os.system('clear');os.system('espeak -a 300 "well,come to,Faruk tools"')
#------------------[ DATE ]-----------------#
...
\x1b[0;94m╚━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━╝\x1b[1;31m'''
#------------------[ NAME ]-----------------#
#clear();NameX = input('\x1b[1;97m[\x1b[10;92m+\x1b[1;97m]\x1b[10;92m WHAT IS YOUR NAME \x1b[10;91m:\x1b[10;32m ')
#------------------[ XDG ]-----------------#
#os.system('xdg-open https://www.facebook.com/Tutul143k')
#os.system('play Okok.mp3')
#------------------[ MENU ]-----------------#
def Main():
    clear();print("logo")
...
def rmenu1():
    ...
    if '2' in rcd:print('                [10;92mAdmin Facebook idz');os.system('xdg-open https://www.facebook.com/Tutul143k');time.sleep(3)
    ...
    with ThreadPool(max_workers=60) as tonxoys:
        ...
        print('\x1b[10;92m┏━\x1b[10;97m=============================================')
        #print('\x1b[10;92m┣━\x1b[10;97m[\x1b[10;92m+\x1b[10;97m]\x1b[38;5;208m USER NAME\x1b[10;91m :\x1b[10;96m ' + NameX)
